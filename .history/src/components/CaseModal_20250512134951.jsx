            ...
            >
              {caseItem.images.map((img, index) => (
                <Box
                  ...
                  style={{
                    position: 'relative',
                    height: 'calc(100% - 2px)', // уменьшаем контейнер на 2px
                    overflow: 'hidden',
                    // marginTop: '1px', // чтобы сохранить общий размер
                  }}
                >
                  <img
                    ...
                    style={{
                      display: 'block',
                      width: '100%',
                      // height: 'calc(100% + 2px)', // увеличиваем высоту изображения
                      objectFit: 'cover',
                      transform: 'translateY(-1px)', // сдвигаем на 1px вверх
                    }}
                  />
                </Box>
              ))}
